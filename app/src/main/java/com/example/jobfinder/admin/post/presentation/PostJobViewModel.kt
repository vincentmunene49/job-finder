...
class PostJobViewModel @Inject constructor(
        ...
        when (event) {
            ...
            JobPostingEvent.OnClickPostJob -> {
                ...
                if (validateEmail() && validateGeneralField(state.jobTitle ?: "", "jobTitle") &&
                    ...
                    validateGeneralField(state.requirements?.joinToString(separator = ", ") ?: "", "requirements")
                ) {
                    postJob()
                }
    ...
    private fun postJob(){
        val job = Job(
            ...
            jobLocation = "${state.jobCity}, ${state.jobCountry}",
            companyEmail = state.companyEmail ?: "",
            requirements = state.requirements ?: mutableListOf()
        )
